...
/* Constants */
#define ENCODER_A_PIN GPIO_PIN_2 // Replace with Tach B pin
#define ENCODER_B_PIN GPIO_PIN_3 // Replace with Tach A pin
...
/*volatile uint32_t encoder_count =1; // encoder pulses
#define SAMPLE_TIME_MS 10
float speed=0.0f ;
float angle=0.0f ;*/
char CH1[50],CH2[50]; // Assuming a maximum of 50 characters for the string
