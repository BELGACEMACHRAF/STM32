...
osThreadId TorqueTaskHandle;
osThreadId BITE_TAREHandle;
osMessageQId TorqueQueueHandle;
...
/* USER CODE BEGIN Header_vTask_speed */
/**
...
void vTask_speed(void const * argument)
{
  ...
  /* USER CODE END vTask_speed */
}

/* USER CODE BEGIN Header_vTask_torque */
/**
* @brief Function implementing the TorqueTask thread.
* @param argument: Not used
* @retval None
*/
...
void vTask_torque(void const * argument)
{
  ...
  /* USER CODE END vTask_torque */
}

/* USER CODE BEGIN Header_vTaskBITE_TARE */
/**
* @brief Function implementing the BITE_TARE thread.
* @param argument: Not used
* @retval None
*/
