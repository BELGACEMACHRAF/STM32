  ...
  /* USER CODE END LTDC_MspInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = LCD_B1_Pin|LCD_B0_Pin|LCD_B2_Pin|LCD_B3_Pin
                          ...
                          |LCD_G2_Pin|LCD_R7_Pin|LCD_R5__Pin|LCD_R6_Pin
                          |LCD_R4__Pin|LCD_R3__Pin|LCD_R1_Pin|LCD_R2_Pin;
...
static void HAL_FMC_MspInit(void){
  ...
  PE13   ------> FMC_D10
  */
  GPIO_InitStruct.Pin = A20__IS61WV102416BLL_A20_Pin|A19_Pin|A23_Pin|FMC_NBL1_Pin
                          |FMC_NBL0_Pin|A21_Pin|A22_Pin|D5_Pin
  ...
  GPIO_InitStruct.Pin = SDNCAS_Pin|FMC_NE3_Pin|SDCLK_Pin|A11_Pin
                          |A13_Pin|A12_Pin|A10_Pin|GPIO_PIN_5
                          |GPIO_PIN_4;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
static void HAL_FMC_MspDeInit(void){
  ...
  PE13   ------> FMC_D10
  */
  HAL_GPIO_DeInit(GPIOE, A20__IS61WV102416BLL_A20_Pin|A19_Pin|A23_Pin|FMC_NBL1_Pin
                          |FMC_NBL0_Pin|A21_Pin|A22_Pin|D5_Pin
                          |D6_Pin|D8_Pin|D11_Pin|D4_Pin
                          |D7_Pin|D9_Pin|D12_Pin|D10_Pin);
  ...
  HAL_GPIO_DeInit(GPIOG, SDNCAS_Pin|FMC_NE3_Pin|SDCLK_Pin|A11_Pin
                          |A13_Pin|A12_Pin|A10_Pin|GPIO_PIN_5
                          |GPIO_PIN_4);
...
/* SAI2 */
    ...
    */
    ...
    HAL_GPIO_DeInit(SAI2_SCKB_GPIO_Port, SAI2_SCKB_Pin);
