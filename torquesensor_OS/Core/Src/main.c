...
osThreadId vTaskReadTorqueHandle;
osThreadId vTaskMainHandle;
osMessageQId xTorqueSensorQueueHandle;
...
/* USER CODE BEGIN Header_TaskReadTorqueSensor */
/**
  * @brief  Function implementing the vTaskReadTorque thread.
